...
private final class WithLatestFromSink<FirstType, SecondType, O: ObserverType>:
    Sink<O>,
    ObserverType,
    LockOwnerType,
    SynchronizedOnType {
...
private final class WithLatestFromSecond<FirstType, SecondType, O: ObserverType>:
    ObserverType,
    LockOwnerType,
    SynchronizedOnType {
    typealias ResultType = O.E
