...
private final class ObservableOptionalScheduledSink<O: ObserverType>: Sink<O> {
    typealias E = O.E
...
private final class ObservableOptionalScheduled<E>: Producer<E> {
...
private final class ObservableOptional<E>: Producer<E> {
