...
private final class AmbObserver<O: ObserverType>: ObserverType {
...
private final class AmbSink<O: ObserverType>: Sink<O> {
    ...
    func run() -> Disposable {
        ...
        let forwardEvent = { (_: AmbObserverType, event: Event<ElementType>) -> Void in
